#!/bin/bash
# Ours: Obs Delay k=3 (Residual Memory, WITH Curriculum)
...
export RUN_NAME="ours_curriculum_obs_delay_3"
...
echo "Disturbance Curriculum: Target Obs Delay k=$OBS_DELAY_K"
