#!/bin/bash
# Ours: Obs Bias b=0.05 (Residual Memory, WITH Curriculum)
...
export RUN_NAME="ours_curriculum_bias_0p05"
...
echo "Disturbance Curriculum: Target Obs Bias b=$OBS_BIAS_B (No other disturbances)"
