#!/bin/bash
# Ours: Obs Dropout Medium (Residual Memory, WITH Curriculum)
...
echo "Disturbance Curriculum: Target Obs Dropout Level=$OBS_DROPOUT_LEVEL (No other disturbances)"
