#!/usr/bin/env bash
# Baseline Push fine-tuning under MixedHard delays (Obs=3, Act=1).
set -euo pipefail
...
RUN_NAME="${RUN_NAME:-baseline_mixedhard_push__seed${SEED}}"
METHOD_TAG="${METHOD_TAG:-baseline_mixedhard_push}"
OUT_ROOT="${OUT_ROOT:-}"
