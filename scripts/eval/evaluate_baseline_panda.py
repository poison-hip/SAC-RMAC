#!/usr/bin/env python3
"""
Evaluate baseline PandaReach model on four test scenarios with 1000 episodes each.
"""
...
def main():
    ...
    # Save results
    output_file = model_dir / f'evaluation_results_{args.n_episodes}ep.json'
    ...
    print("=" * 80)
    print()
    print(f"{'Scenario':<16}{'Success Rate':<21}{'Mean Return':<20}")
    print("-" * 80)
    for result in all_results:
        ...
        print(f"{result['scenario']:<16}{sr:.1%} ± {sr_std:.3f}{'':<8}{ret:.2f} ± {ret_std:.2f}{'':<8}")
    print()
    print("=" * 80)
